...
export const SWAPS_SCENARIOS: Scenario[] = [
  {
    ...
    steps: [
      ...
      { id: "resolution_swap", type: "resolution", prompt: "2 anos se passaram. Como evoluiu o CDI e qual foi o resultado do swap?", scenarios: [
        { id: "cdi_subiu", label: "Cenário A: CDI subiu para 14,25% a.a.", fixingRate: 14.25, description: "A Selic subiu com pressão inflacionária." },
        { id: "cdi_caiu", label: "Cenário B: CDI caiu para 8,50% a.a.", fixingRate: 8.50, description: "Ciclo de corte agressivo levou a Selic a mínimas." },
        { id: "cdi_estavel", label: "Cenário C: CDI estável em 11,50% a.a.", fixingRate: 11.50, description: "O CDI praticamente não se moveu." },
      ]},
    ],
  },
  {
    ...
    steps: [
      ...
      { id: "resolution_cambial", type: "resolution", prompt: "3 anos se passaram. Hora de avaliar o resultado do swap cambial.", scenarios: [
        { id: "dolar_disparou", label: "Cenário A: Dólar subiu para R$ 6,80 (+30,8%)", fixingRate: 6.80, description: "O dólar disparou." },
        { id: "dolar_caiu", label: "Cenário B: Dólar caiu para R$ 4,30 (−17,3%)", fixingRate: 4.30, description: "O real se valorizou." },
        { id: "dolar_estavel", label: "Cenário C: Dólar estável em R$ 5,35 (+2,9%)", fixingRate: 5.35, description: "O câmbio oscilou pouco." },
      ]},
    ],
  },
  {
