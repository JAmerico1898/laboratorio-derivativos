  ...
  },
  {
    ...
    steps: [
      ...
      { id: "resolution_collar", type: "resolution", prompt: "90 dias se passaram. Onde fechou o dólar?", scenarios: [
        { id: "dolar_caiu", label: "Cenário A: Dólar caiu para R$ 4,60 (−11,5%)", fixingRate: 4.60, description: "Real valorizou forte." },
        { id: "dolar_subiu", label: "Cenário B: Dólar subiu para R$ 5,70 (+9,6%)", fixingRate: 5.70, description: "Dólar subiu além do teto." },
        { id: "dolar_medio", label: "Cenário C: Dólar ficou em R$ 5,25 (+1,0%)", fixingRate: 5.25, description: "Dólar dentro do corredor." },
      ]},
    ],
  },
  {
    ...
    steps: [
      ...
      { id: "resolution_straddle", type: "resolution", prompt: "O resultado de VALE3 saiu. Onde fechou a ação?", scenarios: [
        { id: "queda_forte", label: "Cenário A: VALE3 caiu para R$ 52,00 (−16,1%)", fixingRate: 52.00, description: "Resultado decepcionante." },
        { id: "alta_forte", label: "Cenário B: VALE3 subiu para R$ 72,00 (+16,1%)", fixingRate: 72.00, description: "Resultado excepcional." },
        { id: "estavel", label: "Cenário C: VALE3 ficou em R$ 63,00 (+1,6%)", fixingRate: 63.00, description: "Resultado em linha com expectativas." },
      ]},
    ],
  },
  {
    ...
    steps: [
      ...
      { id: "resolution_rr", type: "resolution", prompt: "90 dias se passaram. Onde fechou o dólar?", scenarios: [
        { id: "dolar_caiu", label: "Cenário A: Dólar caiu para R$ 4,50 (−13,5%)", fixingRate: 4.50, description: "O mercado estava certo em precificar mais risco de queda." },
        { id: "dolar_subiu", label: "Cenário B: Dólar subiu para R$ 5,80 (+11,5%)", fixingRate: 5.80, description: "O skew estava exagerado." },
        { id: "dolar_estavel", label: "Cenário C: Dólar ficou em R$ 5,15 (−1,0%)", fixingRate: 5.15, description: "Dólar dentro do corredor R$ 4,90 – R$ 5,55." },
      ]},
    ],
  },
];
