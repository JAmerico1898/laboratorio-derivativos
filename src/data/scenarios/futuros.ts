  ...
  },
  {
    ...
    steps: [
      ...
      { id: "resolution_spread", type: "resolution", prompt: "Meses passaram. O Copom iniciou o ciclo de corte. Como ficou a curva?", scenarios: [
        { id: "spread_comprimiu", label: "Cenário A: Spread comprimiu para 30bps (Jan/27=10,00%, Jan/28=10,30%)", fixingRate: 30, description: "Ciclo de corte achatou a curva como esperado." },
