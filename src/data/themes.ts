...
export const THEMES: Theme[] = [
  ...
  { id: "credito",   label: "Derivativos de Crédito", icon: "🛡️", materialIcon: "security",           route: "/credito",   description: "CDS e derivativos de crédito: Gerenciamento de risco de contraparte e spreads de crédito." },
